...
plot( t2, x2, 'LineWidth', 2, 'Color', light_red );
plot( t3, x3, 'LineWidth', 2, 'Color', light_blue );
...
xlabel("Time [s]")
ylabel("Position [m]")
legend(["No integral", "With integral", "With anti-windup", "Step"], 'Location', 'southeast');
hold off
set(gca, 'FontName', 'Times New Roman')
set(gca, 'FontSize', 13)
