...
public:
    ...
    BNO080(uint8_t user_CSPin, uint8_t user_WAKPin, uint8_t user_INTPin, uint8_t user_RSTPin);
	...
	boolean beginSPI(uint32_t spiPortSpeed = 3000000, SPIClass &spiPort = SPI);
	...
	uint8_t shtpData[BNO_MAX_PACKET_SIZE];
